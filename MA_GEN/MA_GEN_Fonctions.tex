...
\section{Limites d’une fonction}
    ...
    \begin{defi}{Limite}{}
        Soient $\f{R}$, $a \in \ovl{\mathcal{D}}$ et $L \in \ovl{\mathbb{R}}$.
    ...
    \begin{theo}{Limite de $f(u_n)$}{}
        \begin{soient}
            \item $\f{R}$,
            \item $a \in \ovl{\mathcal{D}}$,
            \item $L \in \ovl{\mathbb{R}}$,
    ...
    \begin{prop}{Limite d’une composée}{}
        \begin{soient}
            ...
            \item $\f{R}$ et $\g{R}$,
            \item $a \in \ovl{\mathcal{D}}$, $b \in \ovl{\mathcal{D'}}$ et $L \in \ovl{\mathbb{R}}$.
        \end{soient}
        \begin{suppose}
    ...
    \begin{theo}{Théorème des gendarmes, ou d’encadrement}{}
        Soient $f,g,h \in \mathcal{F}(\mathcal{D},\mathbb{R})$ et $a \in \ovl{\mathcal{D}}$.
    ...
    \begin{theo}{Limite d’une fonction monotone}{}
        Soient $a,b \in \ovl{\mathbb{R}}$ et $f \in \mathcal{F}(\intervalleOO{a}{b},\mathbb{R})$.
        \begin{enumerate}
...
\subsection{Négligeabilité}
    ...
    \begin{defi}{Négligeabilité}{}
        Soient $f,g \in \mathcal{F}(\mathcal{D},\mathbb{R})$ et $a \in \ovl{\mathcal{D}}$. 
    ...
    \begin{prop}{Propriétés de la négligeabilité}{}
        Soient $a \in \ovl{\mathbb{R}}$, $f,g,h,h_1,h_2$ des fonctions définies au voisinage de $a$ et $\lambda \in \mathbb{R}$.
...
\subsection{Équivalence}
    ...
    \begin{prop}{Caractérisation des équivalents par la limite}{}
        Soient $f \in \mathcal{F}(\mathcal{D},\mathbb{R})$, $a \in \ovl{\mathcal{D}}$ et $\ell \in \mathbb{R}$.
...
\subsection{Équations différentielles linéaires}
    ...
    \begin{demo}{Démonstration}{myolive}
        ...
        \begin{itemize}
            \item Pour $B = 0$, on obtient $\exp(A)\exp(-A) = I_n$. On vient d’établir que pour tout $A \in \mk{n}$, $\exp(A) \in \GL_n(\mathbb{K})$ et 
    ...
    En pratique, les calculs d’exponentielles ne sont pas toujours aisés. Néanmoins, si $A$ et $B$ sont semblables, alors $\exp(A)$ et $\exp(B)$ le sont également. En effet, si $A = P B P^{-1}$ avec $P \in \GL_n(\mathbb{K})$, 
    ...
    \begin{prop}{}{}
        \begin{soient}
            ...
            \item $P \in \GL_n(\mathbb{K})$ tele que $D = P^{-1} A P = \diag(\lambda_1,\ldots,\lambda_n)$
        \end{soient}
    ...
    Soient $A \in \mk{n}$ une matrice diagonalisable et $P \in \GL_n(\mathbb{K})$ telle que $D = P^{-1} A P = \diag(\lambda_1,\ldots,\lambda_n)$. 
    ...
    \begin{omed}{Démonstration}{myred}
        ...
        \begin{enumerate}[label=\textcolor{myred}{(\alph*)}]
            ...
            \[ \forall X \in \mk{n,1}, \quad \nnorm{\infty}{MX} \leq N_{op}{M} \nnorm{\infty}{X} \]
        \end{enumerate}
        L’application \[ \application{I}{\mathbb{R}}{t}{N_{op}{A(t)}} \] est continue comme composée d’applications continues donc est bornée et atteint sa borne supérieure. Il existe donc $M$ tel que 
        \[ \forall t \in I, \quad N_{op}{A(t)} \leq M \]
