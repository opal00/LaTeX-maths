\customchapter{Calcul intégral}{Étudier la notion d’intégrale de Riemann, puis la généraliser à des intégrales impropres, \textit{i.e.} définies sur des ouverts de $\mathbb{R}$. On étendra aussi la notion aux espaces vectoriels normés, et à des fonctions non numériques.}
