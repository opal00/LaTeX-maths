\customchapter{Intégration}{Étudier la notion d’intégrale de Riemann, puis la généraliser à des intégrales impropres, \textit{i.e.} définies sur des ouverts de $\mathbb{R}$. On étendra aussi la notion aux espaces vectoriels normés, et à des fonctions non numériques.}
    ...
    \begin{omed}{Exemple}{myred}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{center}
                \begin{tikzpicture}
                    \tkzTabInit{$x$ / 1, $f(.,t)$ / 3}{$-a$, $\cos(t)$, $a$}
                    \tkzTabVar{+/ $f(-a,t)$, -/ $2 \ln(\sin(t))$, +/ $f(a,t)$}
                \end{tikzpicture}
                \end{center}
                On en déduit que 
                \begin{align*}
...
\subsection{Tribus, tribu borélienne}
    ...
    Une intersection de tribus sur $E$ est encore une tribu sur $E$.
